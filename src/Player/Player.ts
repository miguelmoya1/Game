...
import { ctx, canvas, life, player } from '../Content/Content';
...
export class Player {
  ...
  draw() {
    ...
    ctx.clearRect(this.x - (this.speed * 3), this.y - (this.speed * 3), this.width + (this.speed * 5), this.height + (this.speed * 5));
